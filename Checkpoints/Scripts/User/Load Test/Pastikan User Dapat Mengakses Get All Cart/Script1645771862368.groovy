...
WebUI.click(findTestObject('Home Page/Prod/Page_Pijar Mahir/img_concat(, , kopi, , )_rounded-lg h-full w-full'))

WebUI.click(findTestObject('Home Page/Prod/Page_Pijar Mahir/button_Beli Sekarang'))
